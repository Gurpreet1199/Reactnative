...
const PassSchema=Yup.object().shape({
  ...
  .max(16,'Should be a max of 16 char')
  ...
  return (
    <ScrollView keyboardShouldPersistTaps='handled'>
      <SafeAreaView style={styles.appContainer}>
       ...
       onSubmit={ values =>{
        console.log(values);
        generatePassString(+values.passwordLength)//+ converyts to number
       }}
        >
       {({
         values,
         ...
         <View style={styles.inputWrapper}>
         <Text style={styles.heading}>Include Special Letters</Text>
          <BouncyCheckbox
            disableBuiltInState
            isChecked={symbols}
        ...
        {isPassGenerated ?(
          <View style={[styles.card,styles.cardElevated]}>
            ...
            <Text style={styles.description}>Long press and copy</Text>
